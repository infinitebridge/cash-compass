...
export function Table() {
  const invoices: RevenueTransation[] = [
    {
      invoice_id: 1001,
  ...
  const [rowAction, setRowAction] =
    React.useState<DataTableRowAction<RevenueTransation> | null>(null);
   ...
   */
  const filterFields: DataTableFilterField<RevenueTransation>[] = [
    {
      id: 'customer_name',
      label: 'customer name',
   ...
   */
  const advancedFilterFields: DataTableAdvancedFilterField<RevenueTransation>[] =
    [
      {
        id: 'invoice_id',
        label: 'Name',
