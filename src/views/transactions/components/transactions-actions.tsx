...
export default function Actions() {
  const { onOpenNew, setTransactionType } = useNewTransaction();

  function openTransactionFormSheet(value: TransactionTypes) {
    onOpenNew();
            ...
            <MenuItem>
              {({ focus }) => (
                <button
                  ...
                  onClick={() => openTransactionFormSheet('INCOME')}
                >
                  New Income
                </button>
              )}
            ...
            <MenuItem>
              {({ focus }) => (
                <button
                  ...
                  onClick={() => openTransactionFormSheet('EXPENSE')}
                >
                  New Expense
                </button>
              )}
